...
@SpringBootTest
@ActiveProfiles("test")
class ExisteEntidadeValidatorTest {
    ...
    @Test
    public void EntidadeNulaNaoDeveDarErro(){
        // Cenário
        // Ação
        Set<ConstraintViolation<Teste>> violations = validator.validate(new Teste(null));
    ...
    public static class Teste{
        @ExisteEntidade(fieldName = "nome", domainClass = Categoria.class)
        private String nome;
